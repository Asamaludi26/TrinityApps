    ...
    return (
        <div className="bg-white border-2 border-blue-100 rounded-xl shadow-xl animate-fade-in-up relative">
                                            ...
                                            {Array.from({length: state.approvedQty}).map((_, idx) => {
                                                ...
                                                return (
                                                    <div key={idx} className="flex items-center gap-3">
                                                        <div className="w-8 h-8 flex items-center justify-center bg-white border border-gray-300 rounded-full text-xs font-bold text-gray-500 shadow-sm">{idx + 1}</div>
                                                        <div className="flex-1 min-w-0">
                                                            <CustomSelect 
                                                                options={options}
                                                                value={currentVal}
                                                        ...
                                                        <button 
                                                            ...
                                                            className="p-2 bg-white border border-gray-300 rounded-lg hover:bg-blue-50 text-gray-600 hover:text-tm-primary transition-all shadow-sm"
                                                        >
            ...
            <div className="bg-gray-50 px-6 py-5 border-t border-gray-200 flex justify-end gap-3 rounded-b-xl">
                <button onClick={onCancel} className="px-6 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50">Batal</button>
                <button onClick={handleSubmit} className="px-6 py-2.5 text-sm font-bold text-white bg-tm-primary rounded-lg shadow-sm hover:bg-tm-primary-hover flex items-center gap-2">
